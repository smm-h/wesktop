...
- **src.wesktop.mcp** (`src/wesktop/mcp.py`): wesktop's agent role registry plus the MCP server factory re-exported from fastware: per-role tool provisioning for implementor, auditor, reviewer, and ...
